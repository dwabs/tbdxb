...
export default function NotFound() {
  return (
    <div className="mx-auto flex max-w-[86rem] flex-col items-start px-5 pt-20 pb-28 lg:px-8">
      <p className="font-display text-[0.6875rem] font-semibold tracking-[0.1em] text-accent-deep uppercase">
        404
      </p>
      <h1 className="mt-3 max-w-2xl text-display font-bold text-ink">

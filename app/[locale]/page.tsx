...
function Hero({ t, locale }: { t: Dictionary; locale: Locale }) {
  return (
    <section className="relative overflow-hidden border-b border-line">
      ...
      <div
        aria-hidden="true"
        className="absolute -top-40 -end-32 size-[34rem] rounded-full bg-blush blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-[86rem] px-5 pt-16 pb-12 sm:pt-24 lg:px-8">
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <svg
                  ...
                  className="absolute -bottom-1 start-0 h-3 w-full text-accent-soft"
                >
                  <path
        ...
        <div
          className="animate-rise mt-10 sm:mt-12"
        ...
        >
          ...
          >
            <SearchPanel locale={locale} t={t.search} />
          </Suspense>
        </div>
      </div>
    </section>
 ...
 */
function ListCard({ t }: { t: Dictionary["hero"] }) {
  return (
    <div
      aria-hidden="true"
...
function WhyUs({ t }: { t: Dictionary["home"] }) {
  return (
    <section
      aria-labelledby="why-heading"
      className="mt-24 border-y border-line bg-blush/45"
    >
      <div className="mx-auto max-w-[86rem] px-5 py-20 lg:px-8">
        ...
        <div className="mt-16 flex flex-col items-start gap-4 rounded-card border border-accent-soft bg-paper p-7 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-[0.9375rem] text-ink-muted">{t.ctaBody}</p>
          </div>

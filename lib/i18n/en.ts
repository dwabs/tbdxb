...
export const en = {
  ...
  account: {
    ...
    profile: {
      ...
      uploading: "Uploading…",
      avatarError: "Couldn't upload that photo. Try a smaller image.",
      nameLabel: "Full name",
      nameError: "Enter your name.",
      mobileLabel: "Mobile",
      mobileError: "Enter a mobile number.",
    ...
    address: {
      ...
      line1Placeholder: "Street and building",
      line2Label: "Address line 2",
      line2Placeholder: "Apartment, suite (optional)",
      cityLabel: "City",
    ...
    notifications: {
      title: "Notifications",
      marketingLabel: "Product updates & new experiences",
      marketingBody: "Occasional emails when something new is worth knowing about.",
      remindersLabel: "Booking reminders",
      remindersBody: "Emails about upcoming bookings, once booking is live.",
    ...
    bookingsPage: {
      title: "Bookings",
      upcomingTab: "Upcoming Bookings",
      pastTab: "Past Bookings",
      locationAction: "Location",
      ticketAction: "Ticket",
      invoiceAction: "Invoice Download",
      totalLabel: "Total",
      ...
      emptyUpcomingBody: "Once you book something, it'll show up here.",
      emptyPastTitle: "No past bookings",
      emptyPastBody: "Bookings you've completed will show up here.",
  ...
  checkout: {
    ...
    payment: {
      title: "Payment",
      demoNotice:
        "Demo checkout — no card is charged. Confirming adds a real booking to your account.",
      confirm: "Confirm booking",
      confirming: "Booking…",
      error: "Couldn't complete your booking. Try again.",
      back: "Back",
    },
    confirmation: {
      title: "You're booked",
      body: "A confirmation has been added to your bookings.",
      referenceLabel: "Booking reference",
      scanHint: "Scan to check in",
      viewBookings: "View your bookings",
      browseMore: "Browse more experiences",
    },
  },

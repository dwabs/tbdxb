...
import { BOOKING_STATUS_META, type Booking } from "@/lib/types";
...
/**
 * Shared between the global /bookings list (all events, filterable) and the
 * per-event Bookings tab (one event, no filters) — same table, same
 * actions. showEventColumn hides the Event column when it's already
